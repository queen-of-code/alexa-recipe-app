...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="text-gray-600 dark:text-gray-300 hover:text-violet-700 dark:hover:text-violet-400 rounded p-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
    >
