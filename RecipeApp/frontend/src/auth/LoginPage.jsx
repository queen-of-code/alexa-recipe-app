...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-start justify-center pt-16 px-4">
      <div className="max-w-md w-full mx-auto bg-white dark:bg-gray-900 rounded-xl shadow-md p-8">
